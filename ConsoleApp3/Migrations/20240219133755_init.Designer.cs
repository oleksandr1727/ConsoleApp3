...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleApp3.Entyties.Airplane", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleApp3.Entyties.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleApp3.Entyties.Flight", b =>
                {
            ...
            modelBuilder.Entity("ClientFlight", b =>
                {
                    b.HasOne("ConsoleApp3.Entyties.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsoleApp3.Entyties.Flight", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ConsoleApp3.Entyties.Flight", b =>
                {
                    b.HasOne("ConsoleApp3.Entyties.Airplane", "Airplane")
                        .WithMany("Flights")
