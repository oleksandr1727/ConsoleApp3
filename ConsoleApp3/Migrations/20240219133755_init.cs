    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 300, "Boing747" });

            migrationBuilder.InsertData(
                table: "Airplanes",
                columns: new[] { "Id", "MaxPassanger", "Model" },
                values: new object[] { 2, 200, "AN914" });

            migrationBuilder.InsertData(
                table: "Airplanes",
                columns: new[] { "Id", "MaxPassanger", "Model" },
                values: new object[] { 3, 150, "Mria" });

            migrationBuilder.InsertData(
                table: "Flights",
                columns: new[] { "Number", "AirplaneId", "ArrivalCity", "ArrivalTime", "DepartureCity", "DepartureTime" },
                values: new object[] { 1, 1, "Lviv", new DateTime(2024, 2, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kyiv", new DateTime(2024, 2, 17, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Flights",
                columns: new[] { "Number", "AirplaneId", "ArrivalCity", "ArrivalTime", "DepartureCity", "DepartureTime" },
                values: new object[] { 2, 2, "Lviv", new DateTime(2024, 2, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Varshava", new DateTime(2024, 2, 18, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Flights",
                columns: new[] { "Number", "AirplaneId", "ArrivalCity", "ArrivalTime", "DepartureCity", "DepartureTime" },
                values: new object[] { 3, 3, "Lviv", new DateTime(2024, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kyiv", new DateTime(2024, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified) });
